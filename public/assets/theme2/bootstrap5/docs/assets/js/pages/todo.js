...
$(document).ready(function() {
    ...
    $("#add-btn").on("click", function() {
        ...
        if (task == "") {
            ...
            var add_todo = $('<div class="to-do-list mb-3" id="' + i + '"><div class="d-inline-block"><label class="check-task form-check d-flex justify-content-center"><input type="checkbox" class="form-check-input" onclick="check_task(' + i + ')" id="checkbox' + i + '"><span class="form-check-label" for="checkbox' + i + '">' + task + '</span></label></div><div class="float-end"><a onclick="delete_todo(' + i + ');" href="#!" class="delete_todolist"><i class="far fa-trash-alt"></i></a></div></div>');
            i++;
    ...
    $(".btn_save").on("click", function() {
        ...
        if (saveTask == "") {
            ...
            var add_todo = $('<div class="to-do-list mb-3" id="' + i + '"><div class="d-inline-block"><label class="check-task form-check d-flex justify-content-center"><input type="checkbox" class="form-check-input" onclick="check_task(' + i + ')" id="checkbox' + i + '"><span class="form-check-label" for="checkbox' + i + '">' + saveTask + '</span></label></div><div class="float-end"><a onclick="delete_todo(' + i + ');" href="#!" class="delete_todolist"><i class="far fa-trash-alt"></i></a></div></div>');
            i++;
