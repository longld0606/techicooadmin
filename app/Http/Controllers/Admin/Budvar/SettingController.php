...
class SettingController extends AdminController
{
    ...
    public function index(BudvarSettingDataTable $dataTable)
    {
        $menus = BudvarApi::get('/menu/findAll', []);
        return $dataTable->render('admin.budvar.setting.index', ['menus' => $menus->data]);
    }
    ...
    public function create()
    {
        ...
        return view('admin.budvar.setting.item', ['isAction' => 'create', 'item' => $data, 'menus' => $menus->data]);
    }
    ...
    public function store(FormRequest $request)
    {
        ...
        if ($response->status == 'success') {
            ...
            return redirect()->route('admin.budvar.setting.index')->with('success', 'Thêm thông tin Menu thành công');
        }
    ...
    public function show(string $id)
    {
        ...
        $menus = BudvarApi::get('/menu/findAllCms', []);
        return view('admin.budvar.setting.item', ['isAction' => 'show', 'item' =>  $item, 'menus' => $menus->data]);
    }
    ...
    public function edit(string $id)
    {
        ...
        if (empty($item['type'])) $item['type'] = 'BANNER';
        $menus = BudvarApi::get('/menu/findAllCms', []);
        return view('admin.budvar.setting.item', ['isAction' => 'edit', 'item' =>  $item, 'menus' => $menus->data]);
    }
    ...
    public function update(FormRequest $request, string $id)
    {
        ...
        if ($response->status == 'success') {
            ...
            return redirect()->route('admin.budvar.setting.index')->with('success', 'Chỉnh sửa thông tin Menu thành công');
        }
