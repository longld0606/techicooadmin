                ...
                <div class="row">
                       ...
                       $sections = old('sections[]', isset($item['sections']) ? $item['sections'] : []);
                        ...
                        <div class="box-ck">
                            <div class="d-flex justify-content-start">
                                <button type="button" class="btn btn-primary btn-sm btn-ck-add"><i class="fa fa-plus"></i>&nbsp; Thêm nội dung</button>
                            </div>
                            <div class="box-content-item">
                                <div class="d-flex justify-content-end">
                                    <button type="button" class="btn btn-danger btn-sm  btn-ck-remove"><i class="fa fa-trash"></i>&nbsp; Xóa</button>
                                </div>
                                @include('admin.partials._input_ckeditor', [
                                'title' => 'Nội dung',
                                'name' => 'sections[]',
                                'val' => old('sections', isset($item['sections']) ? $item['sections'] : ''),
                                ])
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group" {{ $isAction=='show' ? 'hidden' : '' }}>
                            ...
                            <input type="file" name="thumbs" id="thumbs" class="form-control form-control-file-img" accept="image/png, image/jpeg" multiple>
            ...
            $(".item-box .form-control[type=file]").on('change', function(event) {
                ...
                output.empty();
                    ...
                    for (var i = 0; i < files.length; i++) { 
                        ...
                        html +=  ('<img src="' + uu + '" style="width:100%; height:auto; border: 1px solid #ccc;" />');
                    }
                    output.append(html);
